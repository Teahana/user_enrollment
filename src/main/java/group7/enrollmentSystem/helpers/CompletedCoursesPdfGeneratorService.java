...
@Service
public class CompletedCoursesPdfGeneratorService {

    public byte[] generateInvoicePdf(CompletedCoursesDTO completedCoursesDTO) throws DocumentException, IOException {
        ...
        document.add(new Paragraph("Student ID: " + completedCoursesDTO.getStudentId(), normalFont));
        document.add(new Paragraph("Student Name: " + completedCoursesDTO.getStudentName(), normalFont));
        document.add(new Paragraph("Programme: " + completedCoursesDTO.getProgramme(), normalFont));
        document.add(new Paragraph("\n"));
        ...
        // Course Data
        for (CourseEnrollmentDto course : completedCoursesDTO.getEnrolledCourses()) {
        ...
        // Total Due Section
        document.add(new Paragraph("\nTOTAL DUE: $" + completedCoursesDTO.getTotalDue(), titleFont));
        document.add(new Paragraph("\n"));
